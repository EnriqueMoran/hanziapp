...
def ensure_tables(cur):
    ...
    cur.execute(
        "CREATE TABLE IF NOT EXISTS batches (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, characters TEXT)"
    )
    cur.execute(
        "CREATE TABLE IF NOT EXISTS groups (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, characters TEXT)"
    )
...
def main():
    ...
    for b in batches:
        cur.execute(
            "INSERT INTO batches (id, name, characters) VALUES (?, ?, ?)",
    ...
    for g in groups:
        cur.execute(
            "INSERT INTO groups (id, name, characters) VALUES (?, ?, ?)",
